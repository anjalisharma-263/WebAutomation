...
public class TestBase {
	...
	public TestBase() {
		try {
			...
			FileInputStream ip = new FileInputStream(
					System.getProperty("user.dir") + "/src/main/java/com/purpleAdmin/qa/config/config.properties");
			// FileInputStream ip = new
			// FileInputStream("/Users/user/Documents/automationCodes/qa-automation/src/main/java/com/purpleAdmin/qa/config/config.properties");
			prop.load(ip);
	...
	public void setExtentReport() {
		extent = ExtentManager.getExtent(System.getProperty("user.dir") + "/src/main/resources/reports/WebLogin.html",
	...
	public static void initialization(String browserName) {
		...
		//	System.setProperty("webdriver.gecko.driver", path + "/src/main/resources/browserSetup/geckodriver");   // For Mac
			System.setProperty("webdriver.gecko.driver", path + "/src/main/resources/browserSetup/Win/geckodriver.exe"); // For Window 64 bit
			driver = new FirefoxDriver();
		} else if (browserName.equals("Safari")) {
			driver = new SafariDriver();
		} else if (browserName.equals("Edge")) {
		//	System.setProperty("webdriver.edge.driver", path + "/src/main/resources/browserSetup/msedgedriver");   // For Mac
			System.setProperty("webdriver.edge.driver", path + "/src/main/resources/browserSetup/Win/msedgedriver.exe"); // For Window 64 bit
