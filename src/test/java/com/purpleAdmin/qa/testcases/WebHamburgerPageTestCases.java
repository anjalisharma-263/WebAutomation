...
public class WebHamburgerPageTestCases extends TestBase {
	...
	public void validateCompanyLogo(HashMap<String, String> dataMap) {
		...
		extentTest = parent.createNode(
				"Validating Company Logo" + dataMap.get("BROWSER_NAME") + " for " + dataMap.get("CAMPUS_NAME"));
		WebBL wb = new WebBL();
		try {
	...
	public void validateSubmitFeedbackBtn(HashMap<String, String> dataMap) {
		initialization(dataMap.get("BROWSER_NAME"), dataMap.get("CAMPUS_NAME"));
		extentTest = parent.createNode("Validating Submit Feedback Button Functionality" + dataMap.get("BROWSER_NAME")
	...
	public void validateFAQsBtn(HashMap<String, String> dataMap) {
		initialization(dataMap.get("BROWSER_NAME"), dataMap.get("CAMPUS_NAME"));
		extentTest = parent.createNode("Validating FAQs Button Functionality" + dataMap.get("BROWSER_NAME") + " for "
	...
	public void validateClearRouteBtn(HashMap<String, String> dataMap) {
		initialization(dataMap.get("BROWSER_NAME"), dataMap.get("CAMPUS_NAME"));
		extentTest = parent.createNode("Validating Clear Route Button Functionality" + dataMap.get("BROWSER_NAME")
				+ " for " + dataMap.get("CAMPUS_NAME"));
		WebBL wb = new WebBL();
	...
	public void validateAppOverviewBtn(HashMap<String, String> dataMap) {
		initialization(dataMap.get("BROWSER_NAME"), dataMap.get("CAMPUS_NAME"));
		extentTest = parent.createNode("Validating App Overview Button Functionality" + dataMap.get("BROWSER_NAME")
				+ " for " + dataMap.get("CAMPUS_NAME"));
		WebBL wb = new WebBL();
		try {
	...
	public void validatePrivacyPolicyBtn(HashMap<String, String> dataMap) {
		initialization(dataMap.get("BROWSER_NAME"), dataMap.get("CAMPUS_NAME"));
		extentTest = parent.createNode("Validating Privacy Policy Button Functionality" + dataMap.get("BROWSER_NAME")
				+ " for " + dataMap.get("CAMPUS_NAME"));
		WebBL wb = new WebBL();
	...
	public void validateEULABtn(HashMap<String, String> dataMap) {
		initialization(dataMap.get("BROWSER_NAME"), dataMap.get("CAMPUS_NAME"));
		extentTest = parent.createNode("Validating EULA Button Functionality" + dataMap.get("BROWSER_NAME") + " for "
				+ dataMap.get("CAMPUS_NAME"));
		WebBL wb = new WebBL();
